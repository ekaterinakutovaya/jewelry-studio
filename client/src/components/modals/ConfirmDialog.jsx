...
export const ConfirmDialog = ({ open, setOpen, deleteHandler }) => {
  const {deleting} = useSelector(state => state.orders);
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        ...
                        Вы уверенны, что хотите удалить запись без возможности восстановления?
                        </p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bg-main-bg px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    type="button"
