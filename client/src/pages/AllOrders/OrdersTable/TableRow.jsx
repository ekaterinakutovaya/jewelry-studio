...
import { dateFormatter, renderUrgency, fileDownload, sendToFraser } from "utils/utils";
...
import { quickOrderUpdate } from "store/OrdersSlice";
import ordersService from "services/orders.service";
import { fetchOrders, clearState, fraserStatusUpdate } from "store/OrdersSlice";
...
const TableRow = ({ item }) => {
  ...
  useEffect(() => {
    setCatIndex(+item.cat_index);
    setStatIndex(+item.stat_index);
    setUrgencyIndex(+item.urgency);
  ...
  return (
    <div className={styles.row}>
      <div className={styles.cell} onClick={handleNavigate}>
        {item.order_id}
      </div>
      <div className={styles.cell} onClick={handleNavigate}>
      ...
      <div
        className={
          editOrderId === item.order_id ? styles.cellEditing : styles.cell
        }
      >
      ...
      <div className={styles.cell}>
        {editOrderId === item.order_id ? (
          <QuickEditBlock
            ...
            orderDeleteHandler={deleteHandler}
          />
        ) : (
